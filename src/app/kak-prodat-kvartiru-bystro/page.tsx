...
export const metadata: Metadata = {
  ...
  description:
    "Подготовьте квартиру к продаже за 10 минут с помощью AI. Профессиональные фото, описание и объявление для Авито и ЦИАН. Квартиры с AI-фото продаются на 73% быстрее.",
  keywords:
