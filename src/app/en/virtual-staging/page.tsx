...
export const metadata: Metadata = {
  ...
  description:
    "Virtual staging for real estate. Add photorealistic furniture to empty rooms in 30 seconds. 38 AI services. Photos that sell homes. 25 interior styles + custom text. From $0.50 per photo.",
  keywords:
  ...
  openGraph: {
    title: "Virtual Staging — AI Furniture in 30 Seconds | GPT Estate",
    description: "Add photorealistic furniture to empty rooms. 38 AI services. Photos that sell homes. $0.50/photo.",
    locale: "en_US",
  },
};
...
export default function EnVirtualStagingPage() {
  return (
    <>
      ...
      >
        <div className="mx-auto max-w-7xl px-6">
          ...
          <h2 className="heading-display text-[32px] leading-[1.1] sm:text-[48px] lg:text-[64px] max-w-2xl mb-16 text-white">
            Real staging: $2,000.{" "}
            <span className="text-terra-400">Virtual: $0.50.</span>
          </h2>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            >
              <div className="text-xs uppercase tracking-widest text-neutral-500 mb-6">Real Staging</div>
            ...
            >
              <div className="text-xs uppercase tracking-widest text-terra-400 mb-6">Virtual Staging (GPT Estate)</div>
              <div className="space-y-5">
                {[
      ...
      >
        <div className="mx-auto max-w-7xl px-6">
          ...
          <h2 className="heading-display text-[32px] leading-[1.1] sm:text-[48px] lg:text-[64px] max-w-xl mb-16 text-white">
            25 styles.{" "}
            <span className="text-terra-400">Or describe your own.</span>
          </h2>
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <span
                key={style}
                className="stagger-child rounded-full px-5 py-2.5 text-sm text-neutral-300"
            ...
            <span
              className="stagger-child rounded-full px-5 py-2.5 text-sm text-terra-400 font-medium"
              style={{ background: "rgba(212,101,75,0.10)", border: "1px solid rgba(212,101,75,0.30)" }}
            >
              + Custom text prompt
            </span>
          </div>
      ...
      >
        <div className="mx-auto max-w-7xl px-6">
          <AllModesGrid title="Not just staging — also" subtitle="37 more AI services" />
        </div>
      </FadeInSection>
      ...
      <CTASplitBanner
        ...
        cta2="Contact us"
        fomo="Join 47,832 agents already using AI staging"
      />
    </>
  );
}
